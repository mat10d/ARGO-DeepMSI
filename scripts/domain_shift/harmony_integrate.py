...
Usage:
    python scripts/domain_shift/harmony_integrate.py                     # all embedding dirs
    python scripts/domain_shift/harmony_integrate.py --embeddings results/embeddings/virchow2_mean
"""
