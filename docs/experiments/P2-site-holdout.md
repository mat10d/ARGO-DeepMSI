# P2 — Leave-one-site-out evaluation

Formerly A2 of the April 2026 runbook; original at `docs/archive/a2_site_holdout.md` on the archive branch `archive/pre-iris-2026-09`.

**Status:** ✅ first pass done 2026-04-22 — results are **concerning**, needs follow-up

**Script:** `scripts/domain_shift/site_holdout.py`
...
```bash
python scripts/domain_shift/site_holdout.py             # sweep all embedding dirs
python scripts/domain_shift/site_holdout.py --embeddings results/embeddings/<model>
```
