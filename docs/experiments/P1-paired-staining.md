# P1 — Within-patient paired staining analysis

Formerly A1 of the April 2026 runbook; original at `docs/archive/a1_paired_staining.md` on the archive branch `archive/pre-iris-2026-09`.

**Status:** ✅ done 2026-04-22

**Script:** `scripts/domain_shift/paired_staining.py` + `scripts/domain_shift/paired_staining_summary.py`
...
```bash
python scripts/domain_shift/paired_staining.py --embeddings results/embeddings/<model>
python scripts/domain_shift/paired_staining_summary.py
```
